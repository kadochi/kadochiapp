...
import { checkoutResultSchema, checkoutStateSchema, createSavedAddressSchema, orderSummarySchema, paymentMethodListSchema, savedAddressListSchema, savedAddressSchema, submitCheckoutSchema } from "../schema/checkout";
...
export const getPaymentMethods = () => bffJson("/api/checkout/payment-methods", { method: "GET" }, (value) => paymentMethodListSchema.parse(value));
