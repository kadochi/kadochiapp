import { listProfileOrders } from "@/features/profile/services/profile.server";
...
export async function GET(request: Request) {
  ...
  try {
    ...
    return jsonOk(await listProfileOrders(page, perPage, id), id, { headers: { "Cache-Control": "no-store" } });
  } catch (error) {
