...
- Use Woo-selected shipping rates and Woo totals. Configure WooCommerce with a 250,000-Toman (2,500,000-IRR) flat rate and a 10% standard tax rate; limit both to Tehran delivery addresses without calculating either amount in browser or custom PHP. The frontend saves the Tehran address before the delivery step so Woo's delivery and tax amounts appear before payment. Gift packaging remains the default and both packaging choices remain zero-fee unless Woo later supplies a configured fee.
